...
from voting.views import admin_tokens, export_tokens,admin_statistics_page
urlpatterns = [
    ...
    path('statistics/', admin_statistics_page, name="admin_statistics_page"),
    ...
    # Voting app URLs (optional namespace)
